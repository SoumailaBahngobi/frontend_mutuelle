...
const TreasurerLoanDashboard = () => {
    ...
    const fetchTreasurerData = async () => {
        try {
            ...
            const pendingResponse = await axios.get(
                'http://localhost:8081/mutuelle/loan_request/treasurer/pending-grant',
            ...
            const grantedResponse = await axios.get(
                'http://localhost:8081/mutuelle/loan_request/treasurer/granted-loans',
                { headers: { Authorization: `Bearer ${token}` } }
            );
    ...
    const handleGrantLoan = async (loanRequestId) => {
        try {
            ...
            const response = await axios.post(
                `http://localhost:8081/mutuelle/loan_request/${loanRequestId}/treasurer/grant`,
    ...
    const handleCancelGrant = async (loanRequestId) => {
        ...
        try {
            ...
            await axios.post(
                `http://localhost:8081/mutuelle/loan_request/${loanRequestId}/treasurer/cancel-grant`,
                { reason },
                { headers: { Authorization: `Bearer ${token}` } }
            );
